...
func (mb *MockBackend) GetState(ctx context.Context, MAC objects.MAC) (io.Reader, error) {
	var buffer bytes.Buffer
...
func (mb *MockBackend) GetPackfile(ctx context.Context, MAC objects.MAC) (io.Reader, error) {
	buffer := bytes.NewReader(mb.packfileMACs[MAC])
	return buffer, nil
}

func (mb *MockBackend) GetPackfileBlob(ctx context.Context, MAC objects.MAC, offset uint64, length uint32) (io.Reader, error) {
	buffer := bytes.NewReader(mb.packfileMACs[MAC])
...
func (mb *MockBackend) GetLock(ctx context.Context, lockID objects.MAC) (io.Reader, error) {
