...
func (s *store) GetState(ctx context.Context, mac objects.MAC) (io.Reader, error) {
...
func (s *store) GetPackfile(ctx context.Context, mac objects.MAC) (io.Reader, error) {
	return nil, unsupported
}

func (s *store) GetPackfileBlob(ctx context.Context, mac objects.MAC, offset uint64, length uint32) (io.Reader, error) {
	return nil, unsupported
}
...
func (s *store) GetLock(ctx context.Context, lockID objects.MAC) (io.Reader, error) {
	return nil, nil
}
