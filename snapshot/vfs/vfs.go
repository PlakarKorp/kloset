...
type Filesystem struct {
	...
	dirpack *btree.BTree[string, objects.MAC, uint64]
...
func NewFilesystem(repo *repository.Repository, root, xattrs, errors objects.MAC, dirpackidx *btree.BTree[string, objects.MAC, uint64]) (*Filesystem, error) {
