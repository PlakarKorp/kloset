...
type StateCache interface {
	...
	GetDelta(blobType resources.Type, blobCsum objects.MAC) iter.Seq2[[]byte, []byte]
	GetDeltasByType(blobType resources.Type) iter.Seq2[[]byte, []byte]
	GetDeltas() iter.Seq2[[]byte, []byte]
	...
	GetDeletedsByType(blobType resources.Type) iter.Seq2[[]byte, []byte]
	GetDeleteds() iter.Seq2[[]byte, []byte]
